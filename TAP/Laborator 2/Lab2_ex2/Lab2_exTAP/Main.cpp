...
int main() {
	...
	for (int i = 0; i < 2; i++) {
		...
		cout << endl << "Ati depus " << sumaD << " si ati beneficiat de o dobanda de " << cont[i].getDobanda();
		cout << " Suma totala + dobanda este de " << cont[i].getSumaTotala() << endl;
		cout << endl << "Introduceti suma pe care doriti sa o retrageti din cont : ";
		cin >> sumaR;
		cout << endl << "Ati retras " << sumaR; 
		cout << " Suma actuala este de " << cont[i].getSumaTotala() << endl;
